...
public:
    ...
    static double binarySearch(double lo, double hi, double target, function<double (double)> func)
    {
    ...
    static vector<int>::iterator lowerBound(vector<int> &arr, int target)
    {
